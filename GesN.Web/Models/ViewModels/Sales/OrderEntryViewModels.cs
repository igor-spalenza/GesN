...
namespace GesN.Web.Models.ViewModels.Sales
{
    ...
    public class CreateOrderEntryViewModel
    {
        [Required(ErrorMessage = "O cliente é obrigatório")]
        [Display(Name = "Cliente")]
        public string CustomerId { get; set; } = string.Empty;
        ...
        public List<OrderEntryTypeSelectionViewModel> AvailableOrderTypes { get; set; } = new()
        {
    ...
    public class EditOrderEntryViewModel
    {
        [Required]
        ...
        public List<OrderEntryItemViewModel> Items { get; set; } = new();
    }

    public class OrderEntryDetailsViewModel
    {
        public string Id { get; set; } = string.Empty;
        public string NumberSequence { get; set; } = string.Empty;
        public string CustomerId { get; set; } = string.Empty;
    ...
    public class OrderEntryIndexViewModel
    {
        public List<OrderEntryViewModel> Orders { get; set; } = new();
        public OrderEntryStatisticsViewModel Statistics { get; set; } = new();
        public OrderEntrySearchViewModel Search { get; set; } = new();
    ...
    public class OrderEntryStatisticsViewModel
    {
        public int TotalOrders { get; set; }
    ...
    public class OrderEntrySearchViewModel
    {
        ...
        public List<OrderEntryStatusSelectionViewModel> GetAvailableStatuses()
        {
            return new List<OrderEntryStatusSelectionViewModel>
            {
        ...
        public List<OrderEntryTypeSelectionViewModel> GetAvailableTypes()
        {
            return new List<OrderEntryTypeSelectionViewModel>
            {
    ...
    public class OrderEntryItemViewModel
    {
        public string? Id { get; set; }
    ...
    public class OrderEntryTypeSelectionViewModel
    {
    ...
    public class OrderEntryStatusSelectionViewModel
    {
